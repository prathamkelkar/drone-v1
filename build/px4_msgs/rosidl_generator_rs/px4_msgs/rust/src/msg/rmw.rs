...
impl ArmingCheckReply {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const HEALTH_COMPONENT_INDEX_AVOIDANCE: u8 = 19;
...
#[link(name = "px4_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__Buffer128() -> *const std::ffi::c_void;
}

#[link(name = "px4_msgs__rosidl_generator_c")]
extern "C" {
    fn px4_msgs__msg__Buffer128__init(msg: *mut Buffer128) -> bool;
    fn px4_msgs__msg__Buffer128__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<Buffer128>, size: usize) -> bool;
    fn px4_msgs__msg__Buffer128__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<Buffer128>);
    fn px4_msgs__msg__Buffer128__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<Buffer128>, out_seq: *mut rosidl_runtime_rs::Sequence<Buffer128>) -> bool;
}

// Corresponds to px4_msgs__msg__Buffer128
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
impl Buffer128 {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const MAX_BUFLEN: u32 = 128;

}


impl Default for Buffer128 {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !px4_msgs__msg__Buffer128__init(&mut msg as *mut _) {
        panic!("Call to px4_msgs__msg__Buffer128__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for Buffer128 {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__Buffer128__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__Buffer128__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__Buffer128__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}

impl rosidl_runtime_rs::Message for Buffer128 {
  type RmwMsg = Self;
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> { msg_cow }
  fn from_rmw_message(msg: Self::RmwMsg) -> Self { msg }
}

impl rosidl_runtime_rs::RmwMessage for Buffer128 where Self: Sized {
  const TYPE_NAME: &'static str = "px4_msgs/msg/Buffer128";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__Buffer128() }
  }
}
...
#[link(name = "px4_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__DifferentialDriveSetpoint() -> *const std::ffi::c_void;
}

#[link(name = "px4_msgs__rosidl_generator_c")]
extern "C" {
    fn px4_msgs__msg__DifferentialDriveSetpoint__init(msg: *mut DifferentialDriveSetpoint) -> bool;
    fn px4_msgs__msg__DifferentialDriveSetpoint__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<DifferentialDriveSetpoint>, size: usize) -> bool;
    fn px4_msgs__msg__DifferentialDriveSetpoint__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<DifferentialDriveSetpoint>);
    fn px4_msgs__msg__DifferentialDriveSetpoint__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<DifferentialDriveSetpoint>, out_seq: *mut rosidl_runtime_rs::Sequence<DifferentialDriveSetpoint>) -> bool;
}

// Corresponds to px4_msgs__msg__DifferentialDriveSetpoint
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
#[repr(C)]
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct DifferentialDriveSetpoint {
    /// time since system start (microseconds)
    pub timestamp: u64,
    ...
    pub closed_loop_speed_control: bool,

    /// yaw rate
    pub yaw_rate: f32,

    /// true if yaw rate is controlled using gyroscope feedback, false if direct feed-forward
    pub closed_loop_yaw_rate_control: bool,

}



impl Default for DifferentialDriveSetpoint {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !px4_msgs__msg__DifferentialDriveSetpoint__init(&mut msg as *mut _) {
        panic!("Call to px4_msgs__msg__DifferentialDriveSetpoint__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for DifferentialDriveSetpoint {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__DifferentialDriveSetpoint__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__DifferentialDriveSetpoint__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { px4_msgs__msg__DifferentialDriveSetpoint__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}

impl rosidl_runtime_rs::Message for DifferentialDriveSetpoint {
  type RmwMsg = Self;
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> { msg_cow }
  fn from_rmw_message(msg: Self::RmwMsg) -> Self { msg }
}

impl rosidl_runtime_rs::RmwMessage for DifferentialDriveSetpoint where Self: Sized {
  const TYPE_NAME: &'static str = "px4_msgs/msg/DifferentialDriveSetpoint";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__DifferentialDriveSetpoint() }
  }
}
