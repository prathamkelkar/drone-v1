...
impl Default for Buffer128 {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::Buffer128::default())
  }
}

impl rosidl_runtime_rs::Message for Buffer128 {
  type RmwMsg = super::msg::rmw::Buffer128;
...
impl Default for DifferentialDriveSetpoint {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DifferentialDriveSetpoint::default())
  }
}

impl rosidl_runtime_rs::Message for DifferentialDriveSetpoint {
  type RmwMsg = super::msg::rmw::DifferentialDriveSetpoint;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        speed: msg.speed,
        closed_loop_speed_control: msg.closed_loop_speed_control,
        yaw_rate: msg.yaw_rate,
        closed_loop_yaw_rate_control: msg.closed_loop_yaw_rate_control,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      speed: msg.speed,
