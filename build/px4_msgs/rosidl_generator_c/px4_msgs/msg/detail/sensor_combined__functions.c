...
px4_msgs__msg__SensorCombined__create(void)
{
...
px4_msgs__msg__SensorCombined__Sequence__init(px4_msgs__msg__SensorCombined__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__SensorCombined)) {
      return false;
    }
  ...
  px4_msgs__msg__SensorCombined__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__SensorCombined)) {
      return false;
    }
