...
px4_msgs__msg__UlogStreamAck__create(void)
{
...
px4_msgs__msg__UlogStreamAck__Sequence__init(px4_msgs__msg__UlogStreamAck__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__UlogStreamAck)) {
      return false;
    }
  ...
  px4_msgs__msg__UlogStreamAck__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__UlogStreamAck)) {
      return false;
    }
