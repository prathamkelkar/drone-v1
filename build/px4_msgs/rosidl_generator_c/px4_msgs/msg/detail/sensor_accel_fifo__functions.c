...
px4_msgs__msg__SensorAccelFifo__create(void)
{
...
px4_msgs__msg__SensorAccelFifo__Sequence__init(px4_msgs__msg__SensorAccelFifo__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__SensorAccelFifo)) {
      return false;
    }
  ...
  px4_msgs__msg__SensorAccelFifo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__SensorAccelFifo)) {
      return false;
    }
