...
px4_msgs__msg__VehicleAngularVelocity__create(void)
{
...
px4_msgs__msg__VehicleAngularVelocity__Sequence__init(px4_msgs__msg__VehicleAngularVelocity__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__VehicleAngularVelocity)) {
      return false;
    }
  ...
  px4_msgs__msg__VehicleAngularVelocity__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__VehicleAngularVelocity)) {
      return false;
    }
