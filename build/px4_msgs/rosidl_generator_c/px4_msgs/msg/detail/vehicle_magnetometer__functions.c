...
px4_msgs__msg__VehicleMagnetometer__create(void)
{
...
px4_msgs__msg__VehicleMagnetometer__Sequence__init(px4_msgs__msg__VehicleMagnetometer__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__VehicleMagnetometer)) {
      return false;
    }
  ...
  px4_msgs__msg__VehicleMagnetometer__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__VehicleMagnetometer)) {
      return false;
    }
