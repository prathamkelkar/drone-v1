...
px4_msgs__msg__LandingGearWheel__create(void)
{
...
px4_msgs__msg__LandingGearWheel__Sequence__init(px4_msgs__msg__LandingGearWheel__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__LandingGearWheel)) {
      return false;
    }
  ...
  px4_msgs__msg__LandingGearWheel__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__LandingGearWheel)) {
      return false;
    }
