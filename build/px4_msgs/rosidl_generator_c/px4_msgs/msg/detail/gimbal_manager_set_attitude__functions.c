...
px4_msgs__msg__GimbalManagerSetAttitude__create(void)
{
...
px4_msgs__msg__GimbalManagerSetAttitude__Sequence__init(px4_msgs__msg__GimbalManagerSetAttitude__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__GimbalManagerSetAttitude)) {
      return false;
    }
  ...
  px4_msgs__msg__GimbalManagerSetAttitude__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__GimbalManagerSetAttitude)) {
      return false;
    }
