...
px4_msgs__msg__EstimatorSensorBias__create(void)
{
...
px4_msgs__msg__EstimatorSensorBias__Sequence__init(px4_msgs__msg__EstimatorSensorBias__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__EstimatorSensorBias)) {
      return false;
    }
  ...
  px4_msgs__msg__EstimatorSensorBias__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__EstimatorSensorBias)) {
      return false;
    }
